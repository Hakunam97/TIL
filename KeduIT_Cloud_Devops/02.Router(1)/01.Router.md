...
* **Data Plane**
  : 빠른 Forwarding을 위해 Control Plane으로부터의 Table 정보를 바탕으로 traffic 제어
* **Management Plane**
...
#### 0x2102 부팅 과정 (Router 기본 모드)
1. 전원 테스트(POST)
2. Bootstrap Booting
3. IOS 찾기
4. OS loading
5. NVRAM lookup
6. NVRAM에 저장된 설정내용이 있다면, RAM으로 Loading 실시
7. NVRAM에 저장된 설정내용이 없다면, Setup 모드 실시
