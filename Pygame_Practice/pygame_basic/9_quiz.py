...
# 똥 만들기
ddong = pygame.image.load("C:\\Users\\hakna\\Desktop\\Python_Workspace\\Del_project\\pygame_Tutorial\\Del_project\\pygame_basic\\enemy.png")
...
while running:
    ...
    if ddong_y_pos > screen_height: # 화면상에서 맨 밑으로 떨어지면
        ddong_y_pos = 0 # 다시 맨 위로 올린다
        ddong_x_pos = random.randint(0, screen_width - ddong_width)
